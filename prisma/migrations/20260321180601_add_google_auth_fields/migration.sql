...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'CONFIRMED', 'SHIPPED', 'DELIVERED', 'COMPLETED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_UPDATE', 'PAYMENT_STATUS', 'DISPUTE_UPDATE', 'NEW_MESSAGE', 'REVIEW_RECEIVED', 'VENDOR_VERIFIED', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "products_campusId_idx" ON "products"("campusId");
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_campusId_fkey" FOREIGN KEY ("campusId") REFERENCES "campuses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
