...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Item not as described' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.DisputeStatus }),
    (0, class_validator_1.IsEnum)(client_1.DisputeStatus),
    __metadata("design:type", String)
], ResolveDisputeDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Full refund issued to buyer' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
